...
This project is a **mini HTML/CSS blog** to demonstrate Git branching and merging.
...
- Merge feature branch into main: `git checkout main` → `git merge feature-add-post`
